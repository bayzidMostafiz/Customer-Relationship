		...
		<div class="container">
			...
			<div
				...
				<div class="col d-flex">
					<div class="category-item text-center flex-fill wow fadeInUp" data-wow-delay="0.2s">
						<div class="mx-auto mb-3">
							<img src="assets/img/icons/category-01.svg" class="img-fluid" alt="img">
						</div>
				...
				<div class="col d-flex">
					<div class="category-item text-center flex-fill wow fadeInUp" data-wow-delay="0.2s">
						<div class="mx-auto mb-3">
							<img src="assets/img/icons/category-02.svg" class="img-fluid" alt="img">
						</div>
				...
				<div class="col d-flex">
					<div class="category-item text-center flex-fill wow fadeInUp" data-wow-delay="0.2s">
						<div class="mx-auto mb-3">
							<img src="assets/img/icons/category-13.svg" class="img-fluid" alt="img">
						</div>
				...
				<div class="col d-flex">
					<div class="category-item text-center flex-fill wow fadeInUp" data-wow-delay="0.2s">
						<div class="mx-auto mb-3">
							<img src="assets/img/icons/category-04.svg" class="img-fluid" alt="img">
						</div>
				...
				<div class="col d-flex">
					<div class="category-item text-center flex-fill wow fadeInUp" data-wow-delay="0.2s">
						<div class="mx-auto mb-3">
							<img src="assets/img/icons/category-05.svg" class="img-fluid" alt="img">
						</div>
				...
				<div class="col d-flex">
					<div class="category-item text-center flex-fill wow fadeInUp" data-wow-delay="0.2s">
						<div class="mx-auto mb-3">
							<img src="assets/img/icons/category-06.svg" class="img-fluid" alt="img">
						</div>
				...
				<div class="col d-flex">
					<div class="category-item text-center flex-fill wow fadeInUp" data-wow-delay="0.2s">
						<div class="mx-auto mb-3">
							<img src="assets/img/icons/category-08.svg" class="img-fluid" alt="img">
						</div>
				...
				<div class="col d-flex">
					<div class="category-item text-center flex-fill wow fadeInUp" data-wow-delay="0.2s">
						<div class="mx-auto mb-3">
							<img src="assets/img/icons/category-09.svg" class="img-fluid" alt="img">
						</div>
				...
				<div class="col d-flex">
					<div class="category-item text-center flex-fill wow fadeInUp" data-wow-delay="0.2s">
						<div class="mx-auto mb-3">
							<img src="assets/img/icons/category-10.svg" class="img-fluid" alt="img">
						</div>
				...
				<div class="col d-flex">
					<div class="category-item text-center flex-fill wow fadeInUp" data-wow-delay="0.2s">
						<div class="mx-auto mb-3">
							<img src="assets/img/icons/category-11.svg" class="img-fluid" alt="img">
						</div>
				...
				<div class="col d-flex">
					<div class="category-item text-center flex-fill wow fadeInUp" data-wow-delay="0.2s">
						<div class="mx-auto mb-3">
							<img src="assets/img/icons/category-12.svg" class="img-fluid" alt="img">
						</div>
	...
	<section class="section popular-section">
		<div class="container">
			...
			<ul class="nav nav-tabs nav-tabs-solid justify-content-center mb-4">
				...
				<li class="nav-item mb-3"><a class="nav-link" href="#removals" data-bs-toggle="tab">Removals</a></li>
				...
				<li class="nav-item mb-3"><a class="nav-link" href="#construction" data-bs-toggle="tab">Construction</a>
				</li>
				<li class="nav-item mb-3"><a class="nav-link" href="#plumbing" data-bs-toggle="tab">Plumbing</a></li>
				<li class="nav-item mb-3"><a class="nav-link" href="#more-service" data-bs-toggle="tab">More
						Services</a></li>
			</ul>
			<div class="tab-content">
				<div class="container tab-pane active" id="computer-service">
					<div class="row g-4 row-cols-1 row-cols-md-2 row-cols-lg-3">
						...
						<div class="col">
							<div class="service-item wow fadeInUp" data-wow-delay="0.2s">
								<div class="service-img position-relative">
									<a href="service-details.html">
										<img src="assets/img/services/service-19.jpg" class="img-fluid rounded"
											alt="img">
									</a>
								</div>
								<div class="service-content mt-3">
						...
						<div class="col">
							<div class="service-item wow fadeInUp" data-wow-delay="0.2s">
								<div class="service-img position-relative">
									<a href="service-details.html">
										<img src="assets/img/services/service-20.jpg" class="img-fluid rounded"
											alt="img">
									</a>
								</div>
								<div class="service-content mt-3">
						...
						<div class="col">
							<div class="service-item wow fadeInUp" data-wow-delay="0.2s">
								<div class="service-img position-relative">
									<a href="service-details.html">
										<img src="assets/img/services/service-21.jpg" class="img-fluid rounded"
											alt="img">
									</a>
								</div>
								<div class="service-content mt-3">
						...
						<div class="col">
							<div class="service-item wow fadeInUp" data-wow-delay="0.2s">
								<div class="service-img position-relative">
									<a href="service-details.html">
										<img src="assets/img/services/service-22.jpg" class="img-fluid rounded"
											alt="img">
									</a>
								</div>
								<div class="service-content mt-3">
						...
						<div class="col">
							<div class="service-item wow fadeInUp" data-wow-delay="0.2s">
								<div class="service-img position-relative">
									<a href="service-details.html">
										<img src="assets/img/services/service-13.jpg" class="img-fluid rounded"
											alt="img">
									</a>
								</div>
								<div class="service-content mt-3">
...
<!-- ==================================================================== -->
      ...
      <div class="container tab-pane fade" id="man">
        <p class="text-center py-5">Man & Van content will be added soon.</p>
      </div>

      <div class="container tab-pane fade" id="furniture">
        <p class="text-center py-5">Furniture Assembly content will be added soon.</p>
      </div>

      <div class="container tab-pane fade" id="electrical">
        <p class="text-center py-5">Electrical content will be added soon.</p>
      </div>

      <div class="container tab-pane fade" id="construction">
        <p class="text-center py-5">Construction content will be added soon.</p>
      </div>

      <div class="container tab-pane fade" id="plumbing">
        <p class="text-center py-5">Plumbing content will be added soon.</p>
      </div>

      <div class="container tab-pane fade" id="more-service">
        <p class="text-center py-5">More Services content will be added soon.</p>
      </div>
			</div>
				...
				<div class="service-item">
					<div class="service-img">
						<div class="img-slider owl-carousel nav-center">
							...
							<div class="slide-images">
								<a href="service-details.html">
									<img src="assets/img/services/service-02.jpg" class="img-fluid" alt="img">
								</a>
							</div>
							<div class="slide-images">
								<a href="service-details.html">
									<img src="assets/img/services/service-03.jpg" class="img-fluid" alt="img">
								</a>
							</div>
						</div>
				...
				<div class="service-item">
					<div class="service-img">
						<div class="img-slider owl-carousel nav-center">
							<div class="slide-images">
								<a href="service-details.html">
									<img src="assets/img/services/service-24.jpg" class="img-fluid" alt="img">
								</a>
							</div>
							<div class="slide-images">
								<a href="service-details.html">
									<img src="assets/img/services/service-05.jpg" class="img-fluid" alt="img">
								</a>
							</div>
							<div class="slide-images">
								<a href="service-details.html">
									<img src="assets/img/services/service-06.jpg" class="img-fluid" alt="img">
								</a>
							</div>
						</div>
				...
				<div class="service-item">
					<div class="service-img">
						<div class="img-slider owl-carousel nav-center">
							<div class="slide-images">
								<a href="service-details.html">
									<img src="assets/img/services/service-25.jpg" class="img-fluid" alt="img">
								</a>
							</div>
							<div class="slide-images">
								<a href="service-details.html">
				...
				<div class="service-item">
					<div class="service-img">
						<div class="img-slider owl-carousel nav-center">
							<div class="slide-images">
								<a href="service-details.html">
									<img src="assets/img/services/service-50.jpg" class="img-fluid" alt="img">
								</a>
							</div>
							<div class="slide-images">
								<a href="service-details.html">
									<img src="assets/img/services/service-11.jpg" class="img-fluid" alt="img">
								</a>
							</div>
							<div class="slide-images">
								<a href="service-details.html">
									<img src="assets/img/services/service-12.jpg" class="img-fluid" alt="img">
								</a>
							</div>
						</div>
					</div>
				...
				<div class="service-item">
					<div class="service-img">
						<div class="img-slider owl-carousel nav-center">
							<div class="slide-images">
								<a href="service-details.html">
									<img src="assets/img/services/service-47.jpg" class="img-fluid" alt="img">
								</a>
							</div>
							<div class="slide-images">
								<a href="service-details.html">
									<img src="assets/img/services/service-48.jpg" class="img-fluid" alt="img">
								</a>
							</div>
							<div class="slide-images">
								<a href="service-details.html">
									<img src="assets/img/services/service-49.jpg" class="img-fluid" alt="img">
								</a>
							</div>
						</div>
				...
				<div class="service-item">
					<div class="service-img">
						<div class="img-slider owl-carousel nav-center">
							<div class="slide-images">
								<a href="service-details.html">
									<img src="assets/img/services/service-51.jpg" class="img-fluid" alt="img">
								</a>
							</div>
							<div class="slide-images">
								<a href="service-details.html">
	...
	<section class="section pt-0 d-none">
		<div class="container">
			<div class="provider-sec">
				...
				<div class="row gx-0">
						...
						<div class="provider-item flex-fill">
							<div class="d-flex align-items-center">
								<a href="provider-details.html" class="avatar avatar-xl me-2">
									<img src="assets/img/profiles/avatar-18.jpg" alt="img" class="rounded-circle">
								</a>
								<div>
						...
						<div class="provider-item flex-fill">
							<div class="d-flex align-items-center">
								...
								<div>
									...
									<p class="fs-14 mb-0"><i class="ti ti-star-filled text-warning me-1"></i>4.8 (200
										Reviews)</p>
						...
						<div class="provider-item flex-fill">
							<div class="d-flex align-items-center">
								...
								<div>
									...
									<p class="fs-14 mb-0"><i class="ti ti-star-filled text-warning me-1"></i>4.6 (270
										Reviews)</p>
						...
						<div class="provider-item flex-fill">
							<div class="d-flex align-items-center">
								...
								<div>
									...
									<p class="fs-14 mb-0"><i class="ti ti-star-filled text-warning me-1"></i>4.8 (300
										Reviews)</p>
						...
						<div class="provider-item flex-fill">
							<div class="d-flex align-items-center">
								...
								<div>
									...
									<p class="fs-14 mb-0"><i class="ti ti-star-filled text-warning me-1"></i>4.9 (370
										Reviews)</p>
					...
					<div class="col-xl-3 col-lg-4 col-md-6 d-flex">
						<div class="provider-item flex-fill">
							<div class="d-flex align-items-center">
								<a href="provider-details.html" class="avatar avatar-xl me-2">
									<img src="assets/img/profiles/avatar-11.jpg" alt="img" class="rounded-circle">
								</a>
								<div>
									<h6><a href="provider-details.html">Benjamin Wade</a></h6>
									<p class="fs-14 mb-0"><i class="ti ti-star-filled text-warning me-1"></i>4.2 (220
										Reviews)</p>
						...
						<div class="provider-item flex-fill">
							<div class="d-flex align-items-center">
								...
								<div>
									...
									<p class="fs-14 mb-0"><i class="ti ti-star-filled text-warning me-1"></i>4.3 (280
										Reviews)</p>
				...
				<div class="text-center view-all wow fadeInUp" data-wow-delay="0.2s">
					<a href="providers.html" class="btn btn-dark">View All<i class="ti ti-arrow-right ms-2"></i></a>
				</div>
			</div>
		</div>
	</section>
	...
	<section class="section rated-section ">
		<div class="container">
			...
			<ul class="nav nav-tabs nav-tabs-solid justify-content-center mb-4">
				<li class="nav-item mb-3"><a class="nav-link" href="#rate-removals" data-bs-toggle="tab">Removals</a>
				</li>
				<li class="nav-item mb-3"><a class="nav-link" href="#rate-furniture" data-bs-toggle="tab">Furniture
						Assembly</a></li>
				...
				<li class="nav-item mb-3"><a class="nav-link" href="#rate-man" data-bs-toggle="tab">Man & Van</a></li>
				<li class="nav-item mb-3"><a class="nav-link" href="#rate-plumbing" data-bs-toggle="tab">Plumbing</a>
				</li>
				<li class="nav-item mb-3"><a class="nav-link" href="#rate-more" data-bs-toggle="tab">More Services</a>
				</li>
			</ul>
			<div class="tab-content">
					...
					<div class="row g-4">
						<div class="col-md-6 col-lg-3">
							<a href="service-details.html" class="rated-wrap">
								<img src="assets/img/services/rated-service-05.jpg" alt="img" class="img-fluid">
								<h6 class="text-white">Laser Tattoo Removal</h6>
							</a>
						</div>
						<div class="col-md-6 col-lg-3">
							<a href="service-details.html" class="rated-wrap">
								<img src="assets/img/services/rated-service-06.jpg" alt="img" class="img-fluid">
								<h6 class="text-white">Surgical Excision</h6>
							</a>
						</div>
						<div class="col-md-6 col-lg-3">
							<a href="service-details.html" class="rated-wrap">
								<img src="assets/img/services/rated-service-07.jpg" alt="img" class="img-fluid">
								<h6 class="text-white">Saline Tattoo Removal</h6>
							</a>
						</div>
						<div class="col-md-6 col-lg-3">
							<a href="service-details.html" class="rated-wrap">
								<img src="assets/img/services/rated-service-08.jpg" alt="img" class="img-fluid">
				...
				<div class="tab-pane fade" id="rate-furniture">
					<div class="row g-4">
						<div class="col-md-6 col-lg-3">
							<a href="service-details.html" class="rated-wrap">
								<img src="assets/img/services/rated-service-09.jpg" alt="img" class="img-fluid">
								<h6 class="text-white">Home Furniture Assembly</h6>
							</a>
						</div>
						<div class="col-md-6 col-lg-3">
							<a href="service-details.html" class="rated-wrap">
								<img src="assets/img/services/rated-service-10.jpg" alt="img" class="img-fluid">
								<h6 class="text-white">Office Furniture Assembly</h6>
							</a>
						</div>
						<div class="col-md-6 col-lg-3">
							<a href="service-details.html" class="rated-wrap">
								<img src="assets/img/services/rated-service-11.jpg" alt="img" class="img-fluid">
								<h6 class="text-white">Fitness Equipment Assembly</h6>
							</a>
						</div>
						<div class="col-md-6 col-lg-3">
							<a href="service-details.html" class="rated-wrap">
								<img src="assets/img/services/rated-service-12.jpg" alt="img" class="img-fluid">
				...
				<div class="tab-pane fade show active" id="rate-electrical">
					<div class="row g-4">
						<div class="col-md-6 col-lg-3 wow fadeInUp" data-wow-delay="0.2s">
							<a href="service-details.html" class="rated-wrap">
								<img src="assets/img/services/rated-service-01.jpg" alt="img" class="img-fluid">
								<h6 class="text-white">Wiring and rewiring</h6>
							</a>
						</div>
						<div class="col-md-6 col-lg-3 wow fadeInUp" data-wow-delay="0.4s">
							<a href="service-details.html" class="rated-wrap">
								<img src="assets/img/services/rated-service-02.jpg" alt="img" class="img-fluid">
								<h6 class="text-white">Ceiling fan installation</h6>
							</a>
						</div>
						<div class="col-md-6 col-lg-3 wow fadeInUp" data-wow-delay="0.6s">
							<a href="service-details.html" class="rated-wrap">
								<img src="assets/img/services/rated-service-03.jpg" alt="img" class="img-fluid">
								<h6 class="text-white">Faulty wiring repair</h6>
							</a>
						</div>
						<div class="col-md-6 col-lg-3 wow fadeInUp" data-wow-delay="0.8s">
							<a href="service-details.html" class="rated-wrap">
								<img src="assets/img/services/rated-service-04.jpg" alt="img" class="img-fluid">
				...
				<div class="tab-pane fade" id="rate-construction">
					<div class="row g-4">
						<div class="col-md-6 col-lg-3">
							<a href="service-details.html" class="rated-wrap">
								<img src="assets/img/services/rated-service-13.jpg" alt="img" class="img-fluid">
								<h6 class="text-white">Residential Construction</h6>
							</a>
						</div>
						<div class="col-md-6 col-lg-3">
							<a href="service-details.html" class="rated-wrap">
								<img src="assets/img/services/rated-service-14.jpg" alt="img" class="img-fluid">
								<h6 class="text-white">Roofing Services</h6>
							</a>
						</div>
						<div class="col-md-6 col-lg-3">
							<a href="service-details.html" class="rated-wrap">
								<img src="assets/img/services/rated-service-15.jpg" alt="img" class="img-fluid">
								<h6 class="text-white">Commercial Construction</h6>
							</a>
						</div>
						<div class="col-md-6 col-lg-3">
							<a href="service-details.html" class="rated-wrap">
								<img src="assets/img/services/rated-service-16.jpg" alt="img" class="img-fluid">
				...
				<div class="tab-pane fade" id="rate-man">
					<div class="row g-4">
						<div class="col-md-6 col-lg-3">
							<a href="service-details.html" class="rated-wrap">
								<img src="assets/img/services/rated-service-17.jpg" alt="img" class="img-fluid">
								<h6 class="text-white">Local Moves</h6>
							</a>
						</div>
						<div class="col-md-6 col-lg-3">
							<a href="service-details.html" class="rated-wrap">
								<img src="assets/img/services/rated-service-18.jpg" alt="img" class="img-fluid">
								<h6 class="text-white">Furniture Delivery</h6>
							</a>
						</div>
						<div class="col-md-6 col-lg-3">
							<a href="service-details.html" class="rated-wrap">
								<img src="assets/img/services/rated-service-19.jpg" alt="img" class="img-fluid">
								<h6 class="text-white">House Clearance</h6>
							</a>
						</div>
						<div class="col-md-6 col-lg-3">
							<a href="service-details.html" class="rated-wrap">
								<img src="assets/img/services/rated-service-20.jpg" alt="img" class="img-fluid">
				...
				<div class="tab-pane fade" id="rate-plumbing">
					<div class="row g-4">
						<div class="col-md-6 col-lg-3">
							<a href="service-details.html" class="rated-wrap">
								<img src="assets/img/services/rated-service-21.jpg" alt="img" class="img-fluid">
								<h6 class="text-white">Water Filtration</h6>
							</a>
						</div>
						<div class="col-md-6 col-lg-3">
							<a href="service-details.html" class="rated-wrap">
								<img src="assets/img/services/rated-service-22.jpg" alt="img" class="img-fluid">
								<h6 class="text-white">Emergency Plumbing Repairs</h6>
							</a>
						</div>
						<div class="col-md-6 col-lg-3">
							<a href="service-details.html" class="rated-wrap">
								<img src="assets/img/services/rated-service-23.jpg" alt="img" class="img-fluid">
								<h6 class="text-white">Drain Cleaning</h6>
							</a>
						</div>
						<div class="col-md-6 col-lg-3">
							<a href="service-details.html" class="rated-wrap">
								<img src="assets/img/services/rated-service-24.jpg" alt="img" class="img-fluid">
		...
		<div class="container">
			...
			<div class="testimonial-slider owl-carousel nav-center">
				...
				<div class="testimonial-item wow fadeInUp" data-wow-delay="0.2s">
					...
					<p class="mb-4">“Exceptional care for my luxury vehicle. The team treated my car with precision and
						care.“</p>
					<div class="d-flex align-items-center justify-content-between">
						<div class="d-flex align-items-center overflow-hidden">
							<span class="avatar avatar-lg flex-shrink-0">
			...
			<div class="text-center wow fadeInUp" data-wow-delay="0.2s">
				...
				<p>
					...
					<img src="assets/img/icons/star-01.svg" class="img-fluid" alt="img">
					<img src="assets/img/icons/star-01.svg" class="img-fluid" alt="img">
					<img src="assets/img/icons/star-01.svg" class="img-fluid" alt="img">
					<img src="assets/img/icons/star-01.svg" class="img-fluid" alt="img">
					<img src="assets/img/icons/star-01.svg" class="img-fluid" alt="img">
	...
	<section class="section provide-section bg-black d-none">
			...
			<div class="row align-items-center">
				<div class="col-md-6 wow fadeInUp" data-wow-delay="0.2s">
					<div class="section-header mb-md-0 mb-3">
						...
						<h2 class="text-white">Post your service <span class="text-linear-primary">in a minute</span>
						</h2>
					</div>
				</div>
		...
		<div class="provider-bg1">
			<img src="assets/img/bg/provide-bg-01.svg" class="img-fluid" alt="img">
		</div>
		<div class="provider-bg2">
			<img src="assets/img/bg/provide-bg-02.svg" class="img-fluid" alt="img">
		</div>
	</section>
	<!-- /Provider Section -->
		...
		<div class="container">
			...
			<div class="blog-slider owl-carousel nav-center nav-center">
				<div class="blog-item wow fadeInUp" data-wow-delay="0.2s">
					<div class="blog-img">
						<a href="blog-details.html">
							<img src="assets/img/blogs/blog-01.jpg" class="img-fluid" alt="img">
						</a>
					</div>
				...
				<div class="blog-item wow fadeInUp" data-wow-delay="0.2s">
					<div class="blog-img">
						<a href="blog-details.html">
							<img src="assets/img/blogs/blog-02.jpg" class="img-fluid" alt="img">
						</a>
					</div>
					<div class="blog-content">
						<p class="fs-14 fw-meium text-gray-9 d-inline-flex align-items-center mb-2">Admin<i
				...
				<div class="blog-item wow fadeInUp" data-wow-delay="0.2s">
					<div class="blog-img">
						<a href="blog-details.html">
							<img src="assets/img/blogs/blog-03.jpg" class="img-fluid" alt="img">
						</a>
					</div>
					<div class="blog-content">
						<p class="fs-14 fw-meium text-gray-9 d-inline-flex align-items-center mb-2">Admin<i
								class="ti ti-circle-filled fs-6 mx-1"></i>08 Feb 2023</p>
						<h6 class="text-truncate mb-2"><a href="blog-details.html">Top Tips for Service Success</a></h6>
				...
				<div class="blog-item wow fadeInUp" data-wow-delay="0.2s">
					<div class="blog-img">
						<a href="blog-details.html">
							<img src="assets/img/blogs/blog-04.jpg" class="img-fluid" alt="img">
						</a>
					</div>
					<div class="blog-content">
						<p class="fs-14 fw-meium text-gray-9 d-inline-flex align-items-center mb-2">Admin<i
				...
				<div class="blog-item wow fadeInUp" data-wow-delay="0.2s">
					<div class="blog-img">
						<a href="blog-details.html">
							<img src="assets/img/blogs/blog-05.jpg" class="img-fluid" alt="img">
						</a>
					</div>
					<div class="blog-content">
						<p class="fs-14 fw-meium text-gray-9 d-inline-flex align-items-center mb-2">Admin<i
						...
						<div class="d-flex align-items-center mb-3">
							<a href="javascript:void(0);"
								class="btn btn-light flex-fill d-flex align-items-center justify-content-center me-3"><img
									src="assets/img/icons/google-icon.svg" class="me-2" alt="Img">Google</a>
							<a href="javascript:void(0);"
								class="btn btn-light flex-fill d-flex align-items-center justify-content-center"><img
									src="assets/img/icons/fb-icon.svg" class="me-2" alt="Img">Facebook</a>
						</div>
					...
					<form action="#" class="digit-group">
						<div class="text-center mb-3">
							...
							<p class="fs-14">OTP sent to your Email Address ending ******<a
									...
									class="__cf_email__"
									data-cfemail="e7838882a7829f868a978b82c984888a">[email&#160;protected]</a></p>
						</div>
