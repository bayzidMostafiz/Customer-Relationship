		...
		<div class="content p-0">
					...
					<div class="row align-items-center">
						<div class="col-lg-6">
							<div class="about-img d-none d-md-block">
								...
								<div class="abt-img">
									<img src="assets/img/providers/provider-23.jpg" class="img-fluid" alt="img">
								</div>
							</div>
						</div>
						<div class="col-lg-6">
							<div class="about-content">
								...
								<p>Welcome to Sheba Lagbe, your premier destination for connecting with top-rated service
									...
									care and more.</p>
								<p>At Sheba Lagbe, our mission is to bridge the gap between service providers and
			...
			<section class="work-section px-0 my-0 work-bg">
				<div class="work-bg-2 d-none d-md-block">
					<img src="assets/img/bg/dotted.png" alt="img" class="img-fluid">
				</div>
				<div class="work-bg-1 d-none d-md-block">
					<img src="assets/img/bg/bg-13.png" alt="img" class="img-fluid">
				</div>
				<div class="container">
					<div class="row">
						...
						<div class="col-md-4 d-flex">
							<div class=" card work-box flex-fill">
								<div class="card-body">
									<div class="work-icon">
										<span>
											<img src="assets/img/icons/about-hands.svg" alt="img">
										</span>
									</div>
						...
						<div class="col-md-4 d-flex">
							<div class=" card work-box flex-fill">
								<div class="card-body">
									<div class="work-icon">
										<span>
											<img src="assets/img/icons/about-documents.svg" alt="img">
										</span>
									</div>
						...
						<div class="col-md-4 d-flex">
							<div class=" card work-box flex-fill">
								<div class="card-body">
									<div class="work-icon">
										<span>
											<img src="assets/img/icons/about-book.svg" alt="img">
										</span>
									</div>
					...
					<div class="row align-items-center">
						...
						<div class="col-md-6">
							<div class="chooseus-img">
								<img src="assets/img/services/service-75.jpg" class="img-fluid" alt="img">
							</div>
						</div>
					</div>
					<div class="row justify-content-center">
						<div class="col-xl-3 col-lg-4 col-sm-6">
							<div class="choose-icon">
								<img src="assets/img/icons/group-stars.svg" class="img-fluid" alt="img">
						...
						<div class="col-xl-3 col-lg-4 col-sm-6">
							<div class="choose-icon">
								<img src="assets/img/icons/expert-team.svg" class="img-fluid" alt="img">
								<div class="choose-info">
									<h3>2583+</h3>
									<p>Expert Team</p>
								</div>
						...
						<div class="col-xl-3 col-lg-4 col-sm-6">
							<div class="choose-icon">
								<img src="assets/img/icons/about-documents.svg" class="img-fluid" alt="img">
								<div class="choose-info">
									<h3>2583+</h3>
						...
						<div class="col-xl-3 col-lg-4 col-sm-6">
							<div class="choose-icon border-0">
								<img src="assets/img/icons/expereience.svg" class="img-fluid" alt="img">
								<div class="choose-info">
									<h3>2583+</h3>
			...
			<!-- Providers Section -->
			<section class="providers-section abt-provider d-none">
				<div class="container">
					<div class="section-heading">
						<div class="row">
							<div class="col-md-6">
								...
								<div class="card-body">
									<div class="providerset-img">
										<a href="provider-details.html">
											<img src="assets/img/providers/provider-12.jpg" alt="img">
										</a>
									</div>
						...
						<div class="col-lg-3 col-md-4 col-sm-6">
							<div class="card providerset p-0">
								<div class="card-body">
									<div class="providerset-img">
										<a href="provider-details.html">
											<img src="assets/img/providers/provider-01.jpg" alt="img">
										</a>
									</div>
									<div class="providerset-content">
										<div class="providerset-price">
						...
						<div class="col-lg-3 col-md-4 col-sm-6">
							<div class="card providerset p-0">
								<div class="card-body">
									<div class="providerset-img">
										<a href="provider-details.html">
											<img src="assets/img/providers/provider-02.jpg" alt="img">
										</a>
									</div>
									<div class="providerset-content">
										<div class="providerset-price">
						...
						<div class="col-lg-3 col-md-4 col-sm-6">
							<div class="card providerset p-0">
								<div class="card-body">
									<div class="providerset-img">
										<a href="provider-details.html">
											<img src="assets/img/providers/provider-03.jpg" alt="img">
										</a>
									</div>
									<div class="providerset-content">
										<div class="providerset-price">
				...
				<div class="container">
					<div class="overlay-img d-none d-md-block">
						<div class="overlay-img-left">
							<img src="assets/img/bg/transperent-circle.png" alt="img" class="img-fluid">
						</div>
						<div class="overlay-img-right">
							<img src="assets/img/bg/bg-graphics.png" alt="img" class="img-fluid">
						</div>
					</div>
					<div class="row">
						<div class="col-md-12 text-center">
							...
							<div class=" owl-carousel testimonial-slider-3">
									...
									<div class="card-body">
										<div class="client-img">
											<a href="javascript:void(0);">
												<img class="img-fluid rounded-circle" alt="Image" src="assets/img/user/user-03.jpg">
											</a>
										</div>
								...
								<div class="card client-widget">
									<div class="card-body">
										<div class="client-img">
											<a href="javascript:void(0);">
												<img class="img-fluid rounded-circle" alt="Image" src="assets/img/user/user-06.jpg">
											</a>
										</div>
										<div class="client-content">
								...
								<div class="card client-widget">
									<div class="card-body">
										<div class="client-img">
											<a href="javascript:void(0);">
												<img class="img-fluid rounded-circle" alt="Image" src="assets/img/user/user-07.jpg">
											</a>
										</div>
										<div class="client-content">
											<p>
